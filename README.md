...
For questions regarding creating your own bot, please head to [this chat](https://t.me/@Vickyflowerbotdicussiongroup) where you'll find a
...
Join the [news channel](https://t.me/@flowerbot_newsi5) if you just want to stay in the loop about new features or
announcements.

Vicky and I can also be found moderating the [flowerbot] support group](https://t.me/flowerbotsupport) aimed at providing help
setting up flowerbot in your chats (*not* for bot clones).
...
Users of [vicky](https://t.me/gamee_gamestelgrambot) are encouraged to migrate to [flowerbot](https://t.me/react_flowerbot), which
...
```
from vickybot.sample_config import Config


class Development(Config):
    OWNER_ID = 254318997  # my telegram ID
    OWNER_USERNAME = "balasarathi"  # my telegram username
